...
void RefFreeFrame::init()
{
    trackableSource = NULL;
}

void RefFreeFrame::deInit()
{
...
void RefFreeFrame::initGL(int screenWidth, int screenHeight)
{    
...
void RefFreeFrame::reset()
{
    curStatus = STATUS_IDLE;
    elapsedBadFrame = 0.0f;
}

void RefFreeFrame::setCreating()
{
...
unsigned long RefFreeFrame::getTimeMS()
{
    struct timeval tv;
...
bool RefFreeFrame::startImageTargetBuilder()
{
...
bool RefFreeFrame::stopImageTargetBuilder()
{
...
bool RefFreeFrame::isImageTargetBuilderRunning()
{
    Vuforia::TrackerManager& trackerManager = Vuforia::TrackerManager::getInstance();
    Vuforia::ObjectTracker* objectTracker = static_cast<Vuforia::ObjectTracker*>(trackerManager.getTracker(Vuforia::ObjectTracker::getClassType()));
